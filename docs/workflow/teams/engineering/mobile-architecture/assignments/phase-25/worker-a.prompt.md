# Phase 25 Worker A Prompt

你是 Worker A，当前轮次是 phase-25，对应 `postgresql-phase-4` 的 verification / acceptance owner。
...
- 若进入第二阶段，明确 phase-25 truth 下 acceptance 是否已收束
