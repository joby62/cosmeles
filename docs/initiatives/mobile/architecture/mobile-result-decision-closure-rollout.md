---
doc_id: mobile-result-decision-closure-rollout
title: Mobile Result Decision Closure Rollout
doc_type: rollout
initiative: mobile
...
superseded_by: mobile-first-run-and-compare-closure-rollout
related_docs:
...
## Lifecycle Note
- This rollout is no longer the current integrated execution freeze.
- It was superseded when first-run funnel execution, compare-result page closure, and result-decision closure were merged into one live rollout:
  - `docs/initiatives/mobile/architecture/mobile-first-run-and-compare-closure-rollout.md`
