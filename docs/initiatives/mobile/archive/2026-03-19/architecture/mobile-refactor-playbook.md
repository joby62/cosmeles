---
doc_id: mobile-refactor-playbook-archive-2026-03-19
title: Archived Mobile Refactor Playbook (2026-03-19 Snapshot)
doc_type: archive
initiative: mobile
...
This file is an archived snapshot of the earlier mobile refactor playbook before the current governed playbook form settled.
It is historical context, not current operating truth.
...
- Worker assignments must be issued as architecture-owned prompt files under `docs/workflow/teams/engineering/mobile-architecture/assignments/`.
...
- archive_source_path: `/Users/lijiabo/Documents/New project/docs/initiatives/mobile/architecture/mobile-refactor-playbook.md`
...
- `docs/workflow/teams/engineering/mobile-architecture/assignments/phase-2/worker-a.prompt.md`
- `docs/workflow/teams/engineering/mobile-architecture/assignments/phase-2/worker-b.prompt.md`
- `docs/workflow/teams/engineering/mobile-architecture/assignments/phase-2/worker-c.prompt.md`

## Phase 3 Prompt Files
- `docs/workflow/teams/engineering/mobile-architecture/assignments/phase-3/worker-a.prompt.md`
- `docs/workflow/teams/engineering/mobile-architecture/assignments/phase-3/worker-b.prompt.md`
- `docs/workflow/teams/engineering/mobile-architecture/assignments/phase-3/worker-c.prompt.md`
...
- `docs/workflow/teams/engineering/mobile-architecture/assignments/phase-4/worker-a.prompt.md`
- `docs/workflow/teams/engineering/mobile-architecture/assignments/phase-4/worker-b.prompt.md`
- `docs/workflow/teams/engineering/mobile-architecture/assignments/phase-4/worker-c.prompt.md`
...
- `docs/workflow/teams/engineering/mobile-architecture/assignments/phase-5/worker-a.prompt.md`
- `docs/workflow/teams/engineering/mobile-architecture/assignments/phase-5/worker-b.prompt.md`
- `docs/workflow/teams/engineering/mobile-architecture/assignments/phase-5/worker-c.prompt.md`

## Phase 5 Owner Freeze Files
- `shared/mobile/contracts/analytics_p0_funnel.v1.json`
- `docs/initiatives/mobile/architecture/mobile-branch-convergence-checklist.md`
...
- `docs/workflow/teams/engineering/mobile-architecture/assignments/phase-6/worker-a.prompt.md`
- `docs/workflow/teams/engineering/mobile-architecture/assignments/phase-6/worker-b.prompt.md`
- `docs/workflow/teams/engineering/mobile-architecture/assignments/phase-6/worker-c.prompt.md`
...
- `docs/workflow/teams/engineering/mobile-architecture/assignments/phase-7/worker-a.prompt.md`
- `docs/workflow/teams/engineering/mobile-architecture/assignments/phase-7/worker-b.prompt.md`
- `docs/workflow/teams/engineering/mobile-architecture/assignments/phase-7/worker-c.prompt.md`
...
- `docs/workflow/teams/engineering/mobile-architecture/assignments/phase-8/worker-a.prompt.md`
- `docs/workflow/teams/engineering/mobile-architecture/assignments/phase-8/worker-b.prompt.md`
- `docs/workflow/teams/engineering/mobile-architecture/assignments/phase-8/worker-c.prompt.md`
...
- `docs/workflow/teams/engineering/mobile-architecture/assignments/phase-9/worker-a.prompt.md`
- `docs/workflow/teams/engineering/mobile-architecture/assignments/phase-9/worker-b.prompt.md`
- `docs/workflow/teams/engineering/mobile-architecture/assignments/phase-9/worker-c.prompt.md`
...
- Archived from: `docs/initiatives/mobile/architecture/mobile-refactor-playbook.md`
- Archived on: `2026-03-19 11:52:00 +0800`
- Original file birth time: `2026-03-14 02:11:19 +0800`
- Original file last modified: `2026-03-19 09:43:00 +0800`
- Archive reason: `Superseded when the live playbook was reduced from historical phase logs to current operating rules and team-owned prompt references.`
