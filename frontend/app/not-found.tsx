...
export default async function NotFound() {
  ...
  const copy =
    locale === "zh"
      ? {
          eyebrow: "页面未找到",
          title: "这个地址不在当前婕选站点的公开路径里。",
          summary: "当前独立站已经按新的公开信息架构重建。你可以从首页或选购页重新开始。",
          primaryCta: "返回首页",
          secondaryCta: "进入选购",
        }
      : {
          eyebrow: "Page not found",
          title: "This route is not part of the new Jeslect storefront.",
          summary: "The new storefront is being rebuilt with a different public information architecture. Start again from Home or Shop.",
          primaryCta: "Home",
          secondaryCta: "Shop",
        };
  return (
    <div className="mx-auto max-w-4xl px-4 pb-16 pt-12">
      <article className="rounded-[36px] border border-black/8 bg-white/92 px-6 py-8 shadow-[0_24px_60px_rgba(15,23,42,0.08)]">
        ...
        <h1 className="site-display mt-5 text-[40px] leading-[0.98] tracking-[-0.05em] text-slate-950">{copy.title}</h1>
        <p className="mt-5 max-w-2xl text-[16px] leading-7 text-slate-600">{copy.summary}</p>
