...
export type MobileAnalyticsOverview = {
  ...
  result_view_sessions: number;
  result_primary_cta_click_sessions: number;
  result_secondary_loop_click_sessions: number;
  utility_return_click_sessions: number;
  compare_result_view_sessions: number;
  choose_start_rate_from_choose_view: number;
  result_view_rate_from_home_primary_cta: number;
  result_primary_cta_rate_from_result_view: number;
  result_loop_entry_rate_from_result_view: number;
  ...
  result_view: number;
  result_primary_cta_click: number;
  result_secondary_loop_click: number;
  utility_return_click: number;
